...
CREATE TYPE public.app_role AS ENUM ('owner', 'coach', 'athlete');
...
-- RLS policy: Only owners can assign roles (will be enforced through edge function)
...
-- RLS policy: Only owners can delete roles
